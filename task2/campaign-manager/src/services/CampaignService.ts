...
export class CampaignService {
  ...
  static async updateCampaign(campaignId: string, campaign: Partial<Campaign>): Promise<Campaign> {
    try {
      const response = await axios.put(`${API_BASE}/campaigns/${campaignId}`, campaign);
      return response.data;
    } catch (error) {
  ...
  static async generateCampaignIdea(prompt: string): Promise<Partial<Campaign>> {
    try {
      const response = await axios.post(`${API_BASE}/campaigns/generate`, { prompt });
      return response.data;
    } catch (error) {
  ...
  static async validateCampaign(campaign: Campaign): Promise<CampaignValidation> {
    try {
      const response = await axios.post(`${API_BASE}/campaigns/validate`, campaign);
      return response.data;
    } catch (error) {
  ...
  static async runPipeline(campaignId: string): Promise<any> {
    try {
      const response = await axios.post(`${API_BASE}/campaigns/${campaignId}/generate`);
      return response.data;
    } catch (error) {
  ...
  static async getGenerationLogs(campaignId: string): Promise<any> {
    try {
      const response = await axios.get(`${API_BASE}/campaigns/${campaignId}/logs`);
      return response.data;
    } catch (error) {
